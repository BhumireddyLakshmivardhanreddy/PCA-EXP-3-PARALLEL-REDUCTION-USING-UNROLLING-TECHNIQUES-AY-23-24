...
<h3>AIM:Parallel reduction using Unrolling Techniques</h3>
...
## OUTPUT:
![image](https://github.com/user-attachments/assets/75b1ee65-fbc5-46e7-818a-f41dcfbbc17e)
![image](https://github.com/user-attachments/assets/41f454a4-5649-45b5-8955-dff804964d4a)


## RESULT:
Thus the program has been executed by unrolling by 8 and unrolling by 16. It is observed that 1048576has executed with less elapsed time than 1048576 with blocks 2.73 ms,116.58 ms..
